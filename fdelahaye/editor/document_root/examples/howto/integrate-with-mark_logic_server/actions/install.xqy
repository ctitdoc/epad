...
xdmp:document-insert('01_installing.xml', <article xml:lang="en-us">
  ...
  <section>
    <title>Config</title>
    <paragraph>The config folder contains configuration files, and javascript files that are loaded by default. This folder currently does not exist with Xopus 5.</paragraph>
  </section>
  <section>
